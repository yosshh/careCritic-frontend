...
const filterData = [
    ...
    },
    {
        ...
        array: ["0-3 yrs", "3-5 yrs", "5-10 yrs", "10+ yrs"],
    }
];

const FilterCardForDoctor = () => {
    return (
        <div className="w-full bg-white p-5 rounded-lg shadow-md">
            <h1 className="font-bold text-xl text-[#441752]">Filter Doctors</h1>
...
export default FilterCardForDoctor;
